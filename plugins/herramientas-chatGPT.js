...
let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Aldair , tu seras *𝚄𝚁𝙰𝙱𝙴 - 𝙼𝙸𝙺𝙾𝚃𝙾*`;
...
try {
const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Aldair, tu seras *𝚄𝚁𝙰𝙱𝙴 - 𝙼𝙸𝙺𝙾𝚃𝙾*`;
